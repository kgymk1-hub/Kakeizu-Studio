...
export default function App() {
  ...
  const handleDeletePlace = async (placeId: string) => {
    ...
    setStatus('Placeを削除し、Event / Sourceのplace_id参照をクリアしました。');
  };
