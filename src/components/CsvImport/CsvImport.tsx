...
import { getImportPolicyOption, importPolicyOptions, type ExistingImportContext, type ImportPolicy, type ImportPreviewResult } from '../../services/importPreviewService';
...
export function CsvImport({ onImported, existingData }: { onImported: (data: NormalizedFamilyData) => Promise<boolean> | boolean; existingData?: ExistingImportContext }) {
  ...
  const analysis = useMemo(() => mappingValidation.canImport ? analyzeMappedCsv(text || SAMPLE_CSV, mapping, sourceName, { importPolicy, existingData }) : undefined, [existingData, importPolicy, mapping, mappingValidation.canImport, sourceName, text]);
